...
var Va=/&/g,Wa=/</g,Xa=/>/g,Ya=/"/g,Za=/'/g,$a=/\x00/g,ab=/[\x00&<>"']/;var bb;a:{var cb=w.navigator;if(cb){var db=cb.userAgent;if(db){bb=db;break a}}bb=""};function eb(a,b){for(var c in a)b.call(void 0,a[c],c,a)}
function fb(a,b){var c=Ca(b),d=c?b:arguments;for(c=c?0:1;c<d.length;c++){if(null==a)return;a=a[d[c]]}return a}
...
function mb(a){var b=Aa(a);if("object"==b||"array"==b){if(z(a.clone))return a.clone();b="array"==b?[]:{};for(var c in a)b[c]=mb(a[c]);return b}return a}
...
;var Ob=-1!=bb.indexOf("Trident")||-1!=bb.indexOf("MSIE"),Pb;var Qb;if(w.document&&Ob){var Rb=w.document;Qb=Rb?Rb.documentMode:void 0}else Qb=void 0;Pb=Qb;var Sb={},Tb=null;var I=window;function Ub(a){this.f=a||{cookie:""}}
...
function dc(a,b,c){var d=arguments,e=document,f=String(d[0]),g=d[1];if(!Yb&&g&&(g.name||g.type)){f=["<",f];g.name&&f.push(' name="',Mb(g.name),'"');if(g.type){f.push(' type="',Mb(g.type),'"');var h={};ob(h,g);delete h.type;g=h}f.push(">");f=f.join("")}f=ec(e,f);g&&("string"===typeof g?f.className=g:Ba(g)?f.className=g.join(" "):bc(f,g));2<d.length&&fc(e,f,d);return f}
...
return a}
var rc={Za:"allow-forms",ab:"allow-modals",bb:"allow-orientation-lock",cb:"allow-pointer-lock",eb:"allow-popups",fb:"allow-popups-to-escape-sandbox",gb:"allow-presentation",hb:"allow-same-origin",ib:"allow-scripts",jb:"allow-top-navigation",kb:"allow-top-navigation-by-user-activation"},tc=pb(function(){return sc()});
...
;var Hc="StopIteration"in w?w.StopIteration:{message:"StopIteration",stack:""};function Ic(){}
Ic.prototype.next=function(){throw Hc;};
Ic.prototype.D=function(){return this};
function Jc(a){if(a instanceof Ic)return a;if("function"==typeof a.D)return a.D(!1);if(Ca(a)){var b=0,c=new Ic;c.next=function(){for(;;){if(b>=a.length)throw Hc;if(b in a)return a[b++];b++}};
return c}throw Error("Not implemented");}
function Kc(a,b){if(Ca(a))try{G(a,b,void 0)}catch(c){if(c!==Hc)throw c;}else{a=Jc(a);try{for(;;)b.call(void 0,a.next(),void 0,a)}catch(c){if(c!==Hc)throw c;}}}
function Lc(a){if(Ca(a))return Ra(a);a=Jc(a);var b=[];Kc(a,function(c){b.push(c)});
return b}
;function Mc(a,b){this.h={};this.f=[];this.F=this.g=0;var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else if(a)if(a instanceof Mc)for(c=Nc(a),d=0;d<c.length;d++)this.set(c[d],a.get(c[d]));else for(d in a)this.set(d,a[d])}
...
m.remove=function(a){return Object.prototype.hasOwnProperty.call(this.h,a)?(delete this.h[a],this.g--,this.F++,this.f.length>2*this.g&&Oc(this),!0):!1};
...
m.D=function(a){Oc(this);var b=0,c=this.F,d=this,e=new Ic;e.next=function(){if(c!=d.F)throw Error("The map has changed since the iterator was created");if(b>=d.f.length)throw Hc;var f=d.f[b++];return a?f:d.h[f]};
...
;function Tc(a){w.setTimeout(function(){throw a;},0)}
var Uc;
function Vc(){var a=w.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&-1==bb.indexOf("Presto")&&(a=function(){var e=ec(document,"IFRAME");e.style.display="none";e.src=yb(new vb(wb,tb())).toString();document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(Hb(Jb));e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=B(function(k){if(("*"==h||
...
var $c;function ad(){if(w.Promise&&w.Promise.resolve){var a=w.Promise.resolve(void 0);$c=function(){a.then(dd)}}else $c=function(){var b=dd;
!z(w.setImmediate)||w.Window&&w.Window.prototype&&-1==bb.indexOf("Edge")&&w.Window.prototype.setImmediate==w.setImmediate?(Uc||(Uc=Vc()),Uc(b)):w.setImmediate(b)}}
var bd=!1,cd=new Wc;function dd(){for(var a;a=cd.remove();){try{a.f.call(a.scope)}catch(b){Tc(b)}Sc(Yc,a)}bd=!1}
;function L(a){this.f=0;this.m=void 0;this.i=this.g=this.h=null;this.j=this.l=!1;if(a!=ya)try{var b=this;a.call(void 0,function(c){ed(b,2,c)},function(c){ed(b,3,c)})}catch(c){ed(this,3,c)}}
...
function id(a){return new L(function(b,c){c(a)})}
L.prototype.then=function(a,b,c){return jd(this,z(a)?a:null,z(b)?b:null,c)};
L.prototype.$goog_Thenable=!0;function kd(a,b){return jd(a,null,b,void 0)}
L.prototype.cancel=function(a){if(0==this.f){var b=new ld(a);Zc(function(){md(this,b)},this)}};
...
D(ld,F);ld.prototype.name="cancel";function vd(){this.g=[];this.f=-1}
...
D(yd,xd);yd.prototype.reset=function(){this.f[0]=1732584193;this.f[1]=4023233417;this.f[2]=2562383102;this.f[3]=271733878;this.f[4]=3285377520;this.j=this.h=0};
...
yd.prototype.digest=function(){var a=[],b=8*this.j;56>this.h?this.update(this.i,56-this.h):this.update(this.i,this.g-(this.h-56));for(var c=this.g-1;56<=c;c--)this.l[c]=b&255,b/=256;zd(this,this.l);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.f[c]>>d&255,++b;return a};function M(){this.g=this.g;this.C=this.C}
M.prototype.g=!1;M.prototype.dispose=function(){this.g||(this.g=!0,this.o())};
function Ad(a,b){a.g?b():(a.C||(a.C=[]),a.C.push(b))}
M.prototype.o=function(){if(this.C)for(;this.C.length;)this.C.shift()()};
function Bd(a){a&&"function"==typeof a.dispose&&a.dispose()}
function Cd(a){for(var b=0,c=arguments.length;b<c;++b){var d=arguments[b];Ca(d)?Cd.apply(null,d):Bd(d)}}
...
;function N(a){M.call(this);this.l=1;this.i=[];this.j=0;this.f=[];this.h={};this.m=!!a}
D(N,M);m=N.prototype;m.subscribe=function(a,b,c){var d=this.h[a];d||(d=this.h[a]=[]);var e=this.l;this.f[e]=a;this.f[e+1]=b;this.f[e+2]=c;this.l=e+3;d.push(e);return e};
...
;function Rd(){}
D(Rd,Qd);Rd.prototype.clear=function(){var a=Lc(this.D(!0)),b=this;G(a,function(c){b.remove(c)})};function Sd(a){this.f=a}
...
m.D=function(a){var b=0,c=this.f,d=new Ic;d.next=function(){if(b>=c.length)throw Hc;var e=c.key(b++);if(a)return e;e=c.getItem(e);if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
D(Td,Sd);function Ud(a,b){this.g=a;this.f=null;if(Ob&&!(9<=Number(Pb))){Vd||(Vd=new Mc);this.f=Vd.get(a);this.f||(b?this.f=document.getElementById(b):(this.f=document.createElement("userdata"),this.f.addBehavior("#default#userData"),document.body.appendChild(this.f)),Vd.set(a,this.f));try{this.f.load(this.g)}catch(c){this.f=null}}}
...
m.D=function(a){var b=0,c=this.f.XMLDocument.documentElement.attributes,d=new Ic;d.next=function(){if(b>=c.length)throw Hc;var e=c[b++];if(a)return decodeURIComponent(e.nodeName.replace(/\./g,"%")).substr(1);e=e.nodeValue;if("string"!==typeof e)throw"Storage mechanism: Invalid value was encountered";return e};
return d};
...
Zd.prototype.D=function(a){var b=this.g.D(!0),c=this,d=new Ic;d.next=function(){for(var e=b.next();e.substr(0,c.f.length)!=c.f;)e=b.next();return a?e.substr(c.f.length):c.g.get(e)};
...
function me(a){var b=[];eb(a,function(c,d){var e=encodeURIComponent(String(d)),f;Ba(c)?f=c:f=[c];G(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
...
function te(a){var b=a.f;try{var c=b.screenX;var d=b.screenY}catch(p){}try{var e=b.outerWidth;var f=b.outerHeight}catch(p){}try{var g=b.innerWidth;var h=b.innerHeight}catch(p){}b=[b.screenLeft,b.screenTop,c,d,b.screen?b.screen.availWidth:void 0,b.screen?b.screen.availTop:void 0,e,f,g,h];c=a.f.top;try{var k=(c||window).document,l="CSS1Compat"==k.compatMode?k.documentElement:k.body;var n=(new $b(l.clientWidth,l.clientHeight)).round()}catch(p){n=new $b(-12245933,-12245933)}k=n;n={};l=new vd;w.SVGElement&&
w.document.createElementNS&&l.set(0);c=uc();c["allow-top-navigation-by-user-activation"]&&l.set(1);c["allow-popups-to-escape-sandbox"]&&l.set(2);w.crypto&&w.crypto.subtle&&l.set(3);w.TextDecoder&&w.TextEncoder&&l.set(4);l=wd(l);n.bc=l;n.bih=k.height;n.biw=k.width;n.brdim=b.join();a=a.g;return n.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[a.visibilityState||a.webkitVisibilityState||a.mozVisibilityState||""]||0,n.wgl=!!I.WebGLRenderingContext,n}
...
za(Df);Df.getInstance();var Ef=[],Ff=!1;function Gf(){if("1"!=fb(ce(),"args","privembed")){var a=function(){Ff=!0;"google_ad_status"in window?O("DCLKSTAT",1):O("DCLKSTAT",2)};
...
Vf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var hb=y("ytEventsEventsListeners")||{};x("ytEventsEventsListeners",hb,void 0);var Xf=y("ytEventsEventsCounter")||{count:0};x("ytEventsEventsCounter",Xf,void 0);
function Yf(a,b,c,d){d=void 0===d?{}:d;a.addEventListener&&("mouseenter"!=b||"onmouseenter"in document?"mouseleave"!=b||"onmouseenter"in document?"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"):b="mouseout":b="mouseover");return gb(function(e){var f="boolean"===typeof e[4]&&e[4]==!!d,g=A(e[4])&&A(d)&&kb(e[4],d);return!!e.length&&e[0]==a&&e[1]==b&&e[2]==c&&(f||g)})}
var Zf=pb(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
...
g=ie(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Zf()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);hb[e]=[a,b,c,g,d];return e}
function $f(a){a&&("string"==typeof a&&(a=[a]),G(a,function(b){if(b in hb){var c=hb[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Zf()||"boolean"===typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete hb[b]}}))}
...
D(bg,M);bg.prototype.H=function(a){void 0===a.f&&Wf(a);var b=a.f;void 0===a.g&&Wf(a);this.f=new Zb(b,a.g)};
...
var ug=y("ytLoggingTransportDispatchedStats_")||{};x("ytLoggingTransportDispatchedStats_",ug,void 0);x("ytytLoggingTransportCapturedTime_",y("ytLoggingTransportCapturedTime_")||{},void 0);function vg(){S(pg);S(qg);qg=0;if(!ib(W)){for(var a in W){var b=og[a];b&&b.isReady()&&(wg(a,b),delete W[a],sg=!1)}ib(W)||xg()}}
...
function wg(a,b){var c=lg[a],d=ug[a]||{};ug[a]=d;var e=Math.round(T());for(p in W[a]){var f=mb,g=b.f||zg();g={client:{hl:g.Fa,gl:g.Ea,clientName:g.Da,clientVersion:g.innertubeContextClientVersion,configInfo:g.Ca}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));h=P("EXPERIMENTS_TOKEN","");""!==h&&(g.client.experimentsToken=h);var k=h=void 0,l=[],n=P("EXPERIMENTS_FORCED_FLAGS",{});for(k in n)l.push({key:k,value:String(n[k])});k=P("EXPERIMENT_FLAGS",{});for(h in k)h.startsWith("force_")&&
...
function Gg(a){a=Object.assign({},a);delete a.Authorization;var b=Bc();if(b){var c=new yd;c.update(P("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();c=3;Ca(b);void 0===c&&(c=0);if(!Tb){Tb={};for(var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".split(""),e=["+/=","+/","-_=","-_.","-_"],f=0;5>f;f++){var g=d.concat(e[f].split(""));Sb[f]=g;for(var h=0;h<g.length;h++){var k=g[h];void 0===Tb[k]&&(Tb[k]=h)}}}c=Sb[c];d=[];for(e=0;e<b.length;e+=3){var l=b[e],n=(f=e+1<b.length)?
...
Ig.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,C()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Dd(b))}catch(f){return}else e=escape(b);Hg(a,e,c,this.g)};
...
function Mg(a){var b=Jg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(T())-d.requestTime)){var e=d.authState,f=Gg(Fg(!1));kb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(T())),Ag(a,d.method,e,{}));delete b[c]}}Jg.set("requests",b,86400,!0)}}
...
c=q(c);for(var d=c.next();!d.done;d=c.next())d=Sg(d.value),(ib(d)||!d.trackingParams&&!d.veType)&&$e(Error("Child VE logged with no data"),"WARNING");c={ca:ah(a),P:a};"UNDEFINED_CSN"==a?uh("visualElementAttached",b,c):Dg("visualElementAttached",b,Ng,c)}
...
;function vh(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||lb(b);this.assets=a.assets||{};this.attrs=a.attrs||lb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
vh.prototype.clone=function(){var a=new vh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Aa(c)?a[b]=lb(c):a[b]=c}return a};function wh(){M.call(this);this.f=[]}
r(wh,M);wh.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.nb)}M.prototype.o.call(this)};var xh=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function yh(a){a=a||"";if(window.spf){var b=a.match(xh);spf.style.load(a,b?b[1]:"",void 0)}else zh(a)}
...
m.o=function(){Mh(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){je(b)}this.Y=null;for(var a in this.j)w[this.j[a]]=null;this.ba=this.f=this.api=null;delete this.X;delete this.m;M.prototype.o.call(this)};
...
;function Ei(a){a=void 0===a?!1:a;M.call(this);this.f=new N(a);Ad(this,Ja(Bd,this.f))}
D(Ei,M);Ei.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
...
r(Fi,Ei);function Gi(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(Dd(a),d.i))}}
Fi.prototype.o=function(){this.i=this.h=null;Ei.prototype.o.call(this)};function Hi(a){M.call(this);this.f=a;this.f.subscribe("command",this.ra,this);this.h={};this.j=!1}
r(Hi,M);m=Hi.prototype;m.start=function(){this.j||this.g||(this.j=!0,Gi(this.f,"RECEIVING"))};
...
m.o=function(){var a=this.f;a.g||Jd(a.f,"command",this.ra,this);this.f=null;for(var b in this.h)Ii(this,b);M.prototype.o.call(this)};function Li(a,b){Hi.call(this,b);this.i=a;this.start()}
...
Li.prototype.o=function(){Hi.prototype.o.call(this);delete this.i};function Mi(a,b,c){M.call(this);var d=this;c=c||P("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.w="*";this.i=c;this.sessionId=null;this.channel="widget";this.A=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.A&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
r(Mi,M);Mi.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.w)}catch(e){ke(e)}}};
Mi.prototype.o=function(){window.removeEventListener("message",this.m);M.prototype.o.call(this)};function Ni(){var a=this.g=new Mi(!!P("WIDGET_ID_ENFORCE")),b=B(this.Oa,this);a.j=b;a.l=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
...
m.dispose=function(){Ni.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Ri(a,b,c){M.call(this);this.f=a;this.i=c;this.j=V(window,"message",B(this.l,this));this.h=new Fi(this,a,b);Ad(this,Ja(Bd,this.h))}
r(Ri,M);Ri.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
Ri.prototype.o=function(){$f(this.j);this.f=null;M.prototype.o.call(this)};function Si(){var a=lb(Ti),b;return kd(new L(function(c,d){a.onSuccess=function(e){ye(e)?c(e):d(new Ui("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new Ui("Unknown request error","net.unknown",e))};
a.O=function(e){d(new Ui("Request timed out","net.timeout",e))};
b=Ie("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof ld&&b.abort();
return id(c)})}
...
Vi.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Qc(a)?a:Wi(a)):2===this.g&&b?(a=b.call(c,this.f),Qc(a)?a:Xi(a)):this};
...
;function Yi(a){F.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Zi;this.isTimeout=a instanceof Ui&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof ld}
r(Yi,F);Yi.prototype.name="BiscottiError";function Zi(){F.call(this,"Biscotti ID is missing from server")}
r(Zi,F);Zi.prototype.name="BiscottiMissingError";var Ti={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},$i=null;function ee(){if("1"===fb(ce(),"args","privembed"))return id(Error("Biscotti ID is not available in private embed mode"));$i||($i=kd(Si().then(aj),function(a){return bj(2,a)}));
return $i}
...
function cj(a,b){R(function(){kd(Si().then(aj,function(c){return bj(b,c)}),ya)},a)}
function dj(){try{var a=y("yt.ads.biscotti.getId_");return a?a():ee()}catch(b){return id(b)}}
;function ej(a){if("1"!==fb(ce(),"args","privembed")){a&&de();try{dj().then(function(){},function(){}),R(ej,18E5)}catch(b){je(b)}}}
...
c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&n){var v=void 0===v?"":v;Te(p,v)||Qe(p,void 0,void 0,void 0,v)}else Qe(p);x("yt.timing.pingSent_",!0,void 0);jh(Yh,new Wh(l.aft+(a||0),void 0))}}li("").tick.ol=T()}v=fj.getInstance();n=!!((ij("f"+(Math.floor(119/31)+1))||0)&67108864);p=1<window.devicePixelRatio;document.body&&Fc(document.body,"exp-invert-logo")&&(p&&!Fc(document.body,"inverted-hdpi")?(l=document.body,l.classList?l.classList.add("inverted-hdpi"):Fc(l,"inverted-hdpi")||
(a=Cc(l),Ec(l,a+(0<a.length?" inverted-hdpi":"inverted-hdpi")))):!p&&Fc(document.body,"inverted-hdpi")&&Gc());n!=p&&(n="f"+(Math.floor(119/31)+1),l=ij(n)||0,l=p?l|67108864:l&-67108865,0==l?delete Z[n]:(p=l.toString(16),Z[n]=p.toString()),v.save())}),tj=ie(function(){var a=jj;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Lf.dispose();a=0;for(var b=Ef.length;a<b;a++){var c=Ef[a];if(!isNaN(c)){var d=y("yt.scheduler.instance.cancelJob");d?d(c):S(c)}}Ef.length=0;yf("//static.doubleclick.net/instream/ad_status.js");Ff=!1;O("DCLKSTAT",0);Cd(lj,kj);if(a=jj)a.removeEventListener("onScreenChanged",oj),a.removeEventListener("onLogClientVeCreated",nj),a.removeEventListener("onLogServerVeCreated",pj),a.removeEventListener("onLogVeClicked",qj),a.removeEventListener("onLogVesShown",
rj),a.destroy();mj={}});
